...
use PressingBundle\Entity\Promotion;
...
class PromotionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $promotions = $em->getRepository('PressingBundle:Promotion')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('PressingBundle\Form\PromotionType', $promotion);
    ...
    {
        $deleteForm = $this->createDeleteForm($promotion);
        $editForm = $this->createForm('PressingBundle\Form\PromotionType', $promotion);
